package com.easemygst.automation.TestListeners;
...
import com.easemygst.automation.Reports.ExtentReportSetup;
...
public class ExtentReportListener extends ExtentReportSetup implements ITestListener
{
	...
	public void onTestFailure(ITestResult result) 
	{
		...
		try 
		{
			extentTest.addScreenCaptureFromPath(TestActions.getScreenshot(driver, result.getMethod().getMethodName()));
		} 
		catch(IOException e) 
		{
			e.printStackTrace();
